...
export default class room_rtm {
  constructor(rtmClient, channel, displayName, uid, room) {
    let roomClass = room;
    ...
    let updateMembersTotal = async (members) => {
    ...
    let addBotMessageToDom = (botMessage) => {
      ...
      let newMessage = `<div class="message__wrapper">
                          <div class="message__body__bot">
                              <strong class="message__author__bot">🤖 Inspector Bot</strong>
    ...
    this.handleMemberJoined = handleMemberJoined;
    this.handleMemberLeft = handleMemberLeft;
    this.leaveChannel = leaveChannel;
    this.getMembers = getMembers;
    this.handleChannelMessage = handleChannelMessage;
    this.addBotMessageToDom = addBotMessageToDom;
  }
}
